...
?>
    <!DOCTYPE html>
    <html><head><?php echo $csslink; ?></head><body><?php echo alert(JText::_('PLG_JUMULTITHUMB_LOGIN'), 'notice'); ?></body></html>
<?php
    return;
}
...
<?php echo $csslink; ?>
<style>
body{ background: transparent; font-size: 102%; margin: 0 20px 0 20px;padding:0}
fieldset{
...
<fieldset class="adminform" style="clear: both; float: left; width: 48%;">
    ...
    <form name="wb" method="post" enctype="multipart/form-data" class="well well-small" action="">
        ...
        <input name="Submit" type="submit" class="btn btn-primary" value="<?php echo JText::_('PLG_JUMULTITHUMB_NOTICE15'); ?>" />
        <input type="hidden" name="watermark" value="big" />
    </form>

    <form name="wbdel" method="post" action="">
        <input name="Submit" type="submit" class="btn btn-inverse" value="<?php echo JText::_('PLG_JUMULTITHUMB_NOTICE16'); ?>" />
